 ...
 */
function clean_journal_block_padding_margin_theme_support($editor_settings, $editor_context)
{
...
add_filter('block_editor_settings_all', 'clean_journal_block_padding_margin_theme_support', 10, 2);
